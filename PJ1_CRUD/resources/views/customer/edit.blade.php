                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    <img src="{{ asset($customer->img) }}" style="width: 100px" alt="">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="bank_account_number"  value="{{ old('back_account_number', $customer->bank_account_number ?? '') }}">
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    <label for="">About</label>
                                    <textarea name="about" id="" class="form-control" value="{{ old('about', $customer->about ?? '') }}"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
